...
void Constants::init() {
    ...
    KeywordRegistry::resetCategoryNames();
    ...
    SENTIMENT_KEYWORDS[u8"부정"] = {
        ...
        u8"짜증", u8"화남", u8"화가", u8"늦", u8"별로에요", u8"엉망", u8"최악이다", u8"실패", u8"구려"
    };

    // Category keywords - 배송
    KeywordRegistry::registerCategoryName(u8"배송");
    ...
    // 품질
    KeywordRegistry::registerCategoryName(u8"품질");
    ...
    // 가격
    KeywordRegistry::registerCategoryName(u8"가격");
    ...
    // 서비스
    KeywordRegistry::registerCategoryName(u8"서비스");
    ...
    // 사용성
    KeywordRegistry::registerCategoryName(u8"사용성");
